...
glm::vec3 lightPos(1.2f, (float)glfwGetTime()* glm::radians(50.0f), 2.0f);
...
int main() {
    ...
    //Position attribute
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)0); //We can say that since we set the location to 1
